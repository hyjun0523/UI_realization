...
public class CompanyDao {
	...
	public List<Company> selectList(String field, String job) throws Exception{
		...
		if(field!=null && job==null) {
			sqlSelect = "SELECT com_index, com_name, pay, field, job FROM company WHERE field= '?' ORDER BY com_index ASC";
			...
			sqlSelect = "SELECT com_index, com_name, pay, field, job FROM company WHERE field= '?' AND job='?' ORDER BY com_index ASC";
			isType = true;
